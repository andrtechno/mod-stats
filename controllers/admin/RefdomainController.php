...
class RefdomainController extends StatsController
{
    ...
    public function actionIndex()
    {
        ...
        while (list($other, $val) = each($newmas)) {
            ...
            $domain = Html::a($dname, "?tz=3&pz=1&s_date=" . $this->sdate . "&f_date=" . $this->fdate . "&qs=" . $other . "&sort=" . (empty($this->sort) ? "ho" : $this->sort));
